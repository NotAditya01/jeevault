...
function updateTabs() {
  ...
  if (currentFilter === "pending") {
    pendingTab.className =
      "py-4 px-1 text-blue-600 dark:text-blue-400 border-b-2 border-blue-600 dark:border-blue-400 font-medium text-sm";
    approvedTab.className =
      "py-4 px-1 text-gray-500 dark:text-gray-400 font-medium text-sm";
  } else {
    approvedTab.className =
      "py-4 px-1 text-blue-600 dark:text-blue-400 border-b-2 border-blue-600 dark:border-blue-400 font-medium text-sm";
    pendingTab.className =
...
async function fetchResources() {
  try {
    ...
    const response = await fetch(
      `/api/admin/resources?status=${currentFilter}`,
      {
        headers: {
            ...
            <div class="p-6">
                ...
                <div class="flex flex-wrap items-center justify-between gap-2 mt-4">
                    <div class="flex items-center gap-4">
                        ...
                        <a href="${
                          resource.url
                        }" target="_blank" class="text-xs text-blue-600 dark:text-blue-400 hover:underline">
...
async function handleEditFormSubmit(e) {
  ...
  const formData = {
    ...
    uploadedBy:
      form.querySelector("#editUploadedBy").value.trim() || "Anonymous",
  };
