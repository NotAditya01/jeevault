document.addEventListener('DOMContentLoaded', function() {
    ...
    uploadForm.addEventListener('submit', async function(e) {
        ...
        if (submitButton) {
            ...
            submitButton.innerHTML = '<i class="bi bi-arrow-repeat spin mr-2"></i> Submitting...';
        }
        ...
        try {
            ...
            showMessage('Your resource has been submitted. It will appear after admin approval.', 'success');
            ...
            setTimeout(() => {
                ...
                if (submitButton) {
                    ...
                    submitButton.innerHTML = '<i class="bi bi-cloud-upload mr-2"></i>Submit Resource';
                }
            }, 3000);
